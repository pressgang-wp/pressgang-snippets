...
use function PressGang\Snippets\wc_attribute_taxonomy_name;
use function PressGang\Snippets\wc_get_attribute_taxonomies;
...
class WooCommerceAcfAttribute {
	...
	public function __construct() {
		add_filter( 'acf/location/rule_types',
			[ $this, 'add_attribute_to_acf' ] );
		add_filter( 'acf/location/rule_values/wc_prod_attr',
			[ $this, 'add_attribute_rules' ] );
		add_filter( 'acf/location/rule_match/wc_prod_attr',
			[ $this, 'match_acf_rules' ] );
	}

	public function add_attribute_to_acf( $choices ) {
		$choices[ __( "Other",
			'acf' ) ]['wc_prod_attr'] = 'WC Product Attribute';
