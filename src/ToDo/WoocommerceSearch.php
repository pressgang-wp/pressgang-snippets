...
class WooCommerceSearch {
	 ...
	 *
	 * TODO Woocommerce bug? loop total prop is set via wc_query not wp_query,
	 * this fixes the total so that pagination is displayed on search results
	 * page. See - wc_setup_loop
	 *
	 */
