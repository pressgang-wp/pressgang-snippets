...
class AcfWysiwygMin {
	...
	public function __construct() {
		...
		\add_action( 'acf/render_field_settings/type=wysiwyg',
			[ $this, 'wysiwyg_render_field_settings' ], 10, 1 );
		\add_action( 'acf/render_field/type=wysiwyg',
			[ $this, 'wysiwyg_render_field' ], 10, 1 );
	}
	...
	public function toolbars( $toolbars ) {
		$toolbars['Minimal']    = [];
		$toolbars['Minimal'][1] = [ 'bold', 'italic', 'underline' ];
