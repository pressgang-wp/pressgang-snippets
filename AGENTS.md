...
- `PressGang\Snippets\Content\DisableCoreArchives` — disables selected built-in post, category, tag, author, and date routes and returns real 404 responses for pretty-permalink and query-string forms. Args: optional `routes` list; defaults to author/date.
